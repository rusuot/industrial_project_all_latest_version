...
import { WishContextProvider } from "./store/WishContext";
import ProductPageManualImport from "./Components/ProductPageManulImport.js";
          ...
          <Routes>
            ...
            {user && (
              <>
                ...
                <Route path="/manualimport" element={<ManualImport />} />
                <Route path="/orders" element={<Orders />} />
                <Route path="/account" element={<Profile />} />
                <Route path="/product/:id" element={<ProductPage />} />
                <Route
                  path="/importedproduct/:id"
                  element={<ProductPageManualImport />}
                />
